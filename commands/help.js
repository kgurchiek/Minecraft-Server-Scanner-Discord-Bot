...
module.exports = {
    ...
    const exampleEmbed = new EmbedBuilder()
		...
		{ name: '/players <ip> <port>', value: 'Attempts to get a list of players on a server'},
    			{ name: 'ip', value: 'The ip address of the server', inline: true },
			{ name: 'port', value: 'The port of the server\n' + 'ㅤ', inline: true },
		{ name: '/search <servers> [minonline] [maxonline] [playerCap] [isfull] [version] [hasImage] [description] [strictDescription]', value: 'searches for a server with specific properties'},
